...
export const metadata = CustomMetaData({ presentURL: SEO_OBJ.NEXTJS_METATAGS.absoluteURL });
...
<MDXImage
  src={SEO_OBJ.NEXTJS_METATAGS.featuredImage}
  alt={SEO_OBJ.NEXTJS_METATAGS.featuredImageAltText}
  title={SEO_OBJ.NEXTJS_METATAGS.featuredImageAltText}
  extraStyling="mb-4"
/>
