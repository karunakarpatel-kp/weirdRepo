...
export const metadata = CustomMetaData({ presentURL: SEO_OBJ.NEXTJS_CONFIG.absoluteURL });
...
<MDXImage
  src={SEO_OBJ.NEXTJS_CONFIG.featuredImage}
  alt={SEO_OBJ.NEXTJS_CONFIG.featuredImageAltText}
  title={SEO_OBJ.NEXTJS_CONFIG.featuredImageAltText}
  extraStyling="mb-4"
/>
