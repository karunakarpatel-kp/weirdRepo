...
export const metadata = CustomMetaData({ presentURL: SEO_OBJ.NEXTJS_IMAGE.absoluteURL });
...
<MDXImage
  src={SEO_OBJ.NEXTJS_IMAGE.featuredImage}
  alt={SEO_OBJ.NEXTJS_IMAGE.featuredImageAltText}
  title={SEO_OBJ.NEXTJS_IMAGE.featuredImageAltText}
  extraStyling="mb-4"
/>
